...
class AddGarages extends StatefulWidget {
  AddGarages({Key key}) : super(key: key);

  @override
  _AddGaragesState createState() => _AddGaragesState();
}

class _AddGaragesState extends State<AddGarages> {
  GlobalKey<FormState> _oFormKey = GlobalKey<FormState>();
  TextEditingController _nomTextEditingController = new TextEditingController();
  TextEditingController _lieuTextEditingController =
      new TextEditingController();
  final TextEditingController _dateDTextController =
      new TextEditingController();
  final TextEditingController _dateFTextController =
      new TextEditingController();
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(EvaIcons.text, color: Colors.black26),
                    ...
                    TextFormField(
                      keyboardType: TextInputType.text,
                      decoration: InputDecoration(
                        prefixIcon: Icon(EvaIcons.map, color: Colors.black26),
                        enabledBorder: OutlineInputBorder(
                            borderSide: new BorderSide(color: Colors.black12),
                            borderRadius: BorderRadius.circular(30.0)),
                        focusedBorder: OutlineInputBorder(
                              ...
                              child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    if (_oFormKey.currentState.validate()) {
                                      ...
                                      var lieu =
                                          _lieuTextEditingController.text;
